...
const EventImageV3: FC<EventImageProps> = ({ event, user }) => {
  ...
  return (
    <>
      ...
      <div className="sticky top-0 z-10 flex flex-row bg-white/40 backdrop-blur-md shadow-xs p-4 border border-white/20 items-center justify-center gap-2">
        <div className="flex flex-col justify-center items-center grow">
          <p className="line-clamp-2 font-bold text-md">{event.name}</p>
          <EventImageDialog imageUrl={event.imageUrl} eventName={event.name} />
        </div>
